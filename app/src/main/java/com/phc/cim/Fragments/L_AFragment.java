...
public class L_AFragment extends Fragment{
    ListView listView;
    ArrayList<HashMap<String, String>> indtabresult;
    ArrayList<HashMap<String, String>> L_Alist;
    int count=1;
    String L_A_ID;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        L_Alist=new ArrayList<HashMap<String, String>>();
        ...
        NotSealedAdapter notSealedAdapter=new NotSealedAdapter(getContext(),L_Alist,L_A_ID,email,password,username,isEdit);
