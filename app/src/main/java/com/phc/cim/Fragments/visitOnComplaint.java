...
public class visitOnComplaint extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        visitOnComplaintID= args.getString("visitOnComplaintID");
        ...
        if(indtabresult!=null) {
            for (int i = 0; i < indtabresult.size(); i++) {
                ...
                if (indtabresult.get(i).get("ActionType").equals(visitOnComplaintID)) {
        ...
        NotSealedAdapter notSealedAdapter=new NotSealedAdapter(getContext(),visitOnComplaintlist,visitOnComplaintID,email,password,username,isEdit);
