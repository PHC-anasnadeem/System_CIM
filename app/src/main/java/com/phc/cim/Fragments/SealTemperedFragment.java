...
public class SealTemperedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SealTemperedID= args.getString("SealTemperedID");
        ...
        if(indtabresult!=null) {
            for (int i = 0; i < indtabresult.size(); i++) {
                ...
                if (indtabresult.get(i).get("ActionType").equals(SealTemperedID)) {
        ...
        NotSealedAdapter notSealedAdapter=new NotSealedAdapter(getContext(),sealTemperedlist,SealTemperedID,email,password,username,isEdit);
