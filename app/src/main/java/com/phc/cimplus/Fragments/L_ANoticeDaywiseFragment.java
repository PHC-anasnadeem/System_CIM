...
public class L_ANoticeDaywiseFragment extends Fragment {
    ListView listView;
    ArrayList<HashMap<String, String>> indtabresult;
    ArrayList<HashMap<String, String>> L_ANoticelist;
    int count=1;
    String Vistdate;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_l__a_notice_daywise, container, false);
        ...
        L_ANoticelist=new ArrayList<HashMap<String, String>>();
        ...
        for (int i = 0; i < indtabresult.size(); i++) {
            ...
            if (pkid != null && visitDate != null && pkid.equals("10") && visitDate.equals(Vistdate)) {
                ...
                L_ANoticelist.add(map);
                count++;
            }
        }


        totaltext.setText("L&A Notice: " +Total);
        Total=0;
        Datewise_SummAdapter datewise_summAdapter =new Datewise_SummAdapter(getContext(),L_ANoticelist,email,password,username,isEdit,PlanTitle);
