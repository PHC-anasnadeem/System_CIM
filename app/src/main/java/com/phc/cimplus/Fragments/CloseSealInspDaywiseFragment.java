...
public class CloseSealInspDaywiseFragment extends Fragment {
    String jsonStr = null;
    ListView listView;
    ArrayList<HashMap<String, String>> indtabresult;
    ArrayList<HashMap<String, String>> closeSealedInsplist;
    int count=1;
    String Vistdate;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_close_seal_insp_daywise, container, false);
        ...
        closeSealedInsplist=new ArrayList<HashMap<String, String>>();
        ...
        for (int i = 0; i < indtabresult.size(); i++) {
            ...
            if (pkid != null && visitDate != null && pkid.equals("9") && visitDate.equals(Vistdate)) {
                ...
                closeSealedInsplist.add(map);
                count++;
            }
        }


        totaltext.setText("Closed Sealed Inspection: " +Total);
        Total=0;
        Datewise_SummAdapter datewise_summAdapter =new Datewise_SummAdapter(getContext(),closeSealedInsplist,email,password,username,isEdit,PlanTitle);
