...
public class VisitOnSpecialTaskDaywiseFragment extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_visit_on_special_task_daywise, container, false);
        ...
        if (indtabresult != null) {
            for (int i = 0; i < indtabresult.size(); i++) {
                ...
                if (pkid != null && visitDate != null && pkid.equals("14") && visitDate.equals(Vistdate)) {
        ...
        totaltext.setText("Visit on Special Task: " +Total);
        Total=0;
        Datewise_SummAdapter datewise_summAdapter =new Datewise_SummAdapter(getContext(),VisitOnSpecialTasklist,email,password,username,isEdit,PlanTitle);
