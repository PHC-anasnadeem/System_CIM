...
import com.phc.cimplus.Adapters.Datewise_SummAdapter;
...
public class NonRegisterHCEDaywiseFragment extends Fragment {
    ListView listView;
    ArrayList<HashMap<String, String>> indtabresult;
    ArrayList<HashMap<String, String>> nonRegisteredlist;
    int count=1;
    String Vistdate;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_non_register_h_c_e_daywise, container, false);
        ...
        nonRegisteredlist=new ArrayList<HashMap<String, String>>();
        ...
        for (int i = 0; i < indtabresult.size(); i++) {
            ...
            if (pkid != null && visitDate != null && pkid.equals("13") && visitDate.equals(Vistdate)) {
                ...
                nonRegisteredlist.add(map);
                count++;
            }
        }


        totaltext.setText("Non-Register HCE Notice Issued: " +Total);
        Total=0;
        Datewise_SummAdapter datewise_summAdapter =new Datewise_SummAdapter(getContext(),nonRegisteredlist,email,password,username,isEdit,PlanTitle);
