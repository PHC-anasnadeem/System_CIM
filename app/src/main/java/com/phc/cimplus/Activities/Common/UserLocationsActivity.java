...
import com.phc.cimplus.DataElements.UserLocation;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    if(Roleid != null && (Roleid.equals("3") || Roleid.equals("5") || Roleid.equals("6"))){
                       startActivity(new Intent(context, com.phc.cimplus.Activities.Inspection.InspectionFilterActivity.class).putExtra("email",email).putExtra("password",password).putExtra("username", username).putExtra("isEdit", isEdit));
                    } else {
                    ...
                    if(Roleid != null && Roleid.equals("3")){
                        startActivity(new Intent(context, com.phc.cimplus.Activities.Inspection.InspectionVisitsActivity.class));
                    } else {
