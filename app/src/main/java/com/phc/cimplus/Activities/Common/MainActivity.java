...
import com.phc.cimplus.Extra.MyLocationService;
import com.phc.cimplus.Extra.NotificationWorker;
import com.phc.cimplus.Managers.WebApiManager;
...
//        }, SPLASH_TIME_OUT);
        ...
        // Prevent multiple instances of MainActivity when launched from the launcher icon
        if (!isTaskRoot()
...
// ...
        ...
        private void navigateToNextScreen(String generalRemarks) {
            ...
            if (generalRemarks == null || generalRemarks.isEmpty() || "null".equalsIgnoreCase(generalRemarks)) {
                if (!roleID.isEmpty() && !userID.isEmpty()) {
                    ...
                    proceedToMainScreen(roleID, prefs);
                } else {
                ...
                builder.setMessage(generalRemarks)
                        ...
                        .setPositiveButton("OK", (dialog, id) -> {
                            if (!finalRoleID.isEmpty() && !finalUserID.isEmpty()) {
                                proceedToMainScreen(finalRoleID, prefs);
                            } else {
                                Intent intent = new Intent(MainActivity.this, Login_Activity.class);
                                startActivity(intent);
                                MainActivity.this.finish();
        ...
        private void proceedToMainScreen(String roleID, SharedPreferences prefs) {
            Intent intent;
            if ("3".equals(roleID)) {
                intent = new Intent(MainActivity.this, com.phc.cimplus.Activities.Inspection.InspectionFilterActivity.class);
            } else {
                ...
                intent.putExtra("isEdit", prefs.getString("isEdit", ""));
                intent.putExtra("isStat", prefs.getString("isStat", ""));
    ...
    private void showLocationDisclosure() {
        ...
        builder.setTitle(R.string.location_disclosure_title);
        builder.setMessage(R.string.location_disclosure_message);
