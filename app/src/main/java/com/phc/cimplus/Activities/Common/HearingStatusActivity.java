...
import com.phc.cimplus.Adapters.HearingAdapter;

import com.phc.cimplus.DataElements.Hearing;
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError) {
                            errorMessage = "Connection timeout. Please check your internet speed.";
                        ...
                        Toast.makeText(HearingStatusActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                    }
                }
        );
