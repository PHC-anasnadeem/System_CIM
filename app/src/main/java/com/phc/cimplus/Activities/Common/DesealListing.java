...
import com.phc.cimplus.Adapters.DiaryEntryAdapter;
import com.phc.cimplus.DataElements.DiaryEntry;
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DesealListing.this, errorMessage, Toast.LENGTH_LONG).show();
                    }
                }
        );
