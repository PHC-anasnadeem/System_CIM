...
import com.phc.cimplus.Activities.Common.UserLocationsActivity;
import com.phc.cimplus.Activities.Licensing.PWSFilterActivity;
import com.phc.cimplus.DownloadClases.DownloadInspDetail;
...
public class InspectionFilterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isStat = prefs.getString("isStat", "");
        email = prefs.getString("email", "");
        password = prefs.getString("password", "");
        username = prefs.getString("username", "");
        isEdit = prefs.getString("isEdit", "");
        Roleid = prefs.getString("RoleID", "");
        String userID = prefs.getString("UserID", "");

        // Session guard: if session data is missing, redirect to Login cleanly.
        if (Roleid == null || Roleid.isEmpty() || userID == null || userID.isEmpty()) {
            Intent loginIntent = new Intent(this, com.phc.cimplus.Activities.Common.Login_Activity.class);
       ...
       // simpleSwitch1 = (Switch) findViewById(R.id.simpleSwitch1);
        ...
        if ("1".equals(Roleid)) {
            ...
            if ("true".equals(isStat) && "1".equals(Roleid)) {
...
//                        return true;
    ...
    public void onBackPressed() {
        ...
        // If there is a back stack or we are not the root, go back normally
