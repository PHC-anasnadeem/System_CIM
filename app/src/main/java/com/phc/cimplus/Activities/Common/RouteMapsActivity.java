...
import com.phc.cimplus.BroadcastService.BroadCastService;
import com.phc.cimplus.DownloadClases.DownloadHCEDetail;
...
import com.phc.cimplus.Others.DirectionDataParser;
...
//            pDialog.dismiss();
    ...
    private String getDirectionsUrl(double des_lat, double des_lng) {
                ...
                String url="https://maps.googleapis.com/maps/api/directions/json?origin="+ cur_latitude + "," + cur_longitude +"&destination="+ des_lat +","+des_lng+ "&" + sensor + "&" + mode + "&key=" + getString(R.string.google_directions_key);
